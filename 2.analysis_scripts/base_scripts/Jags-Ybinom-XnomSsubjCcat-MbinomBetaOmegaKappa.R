...
source("./2.analysis_scripts/base_scripts/DBDA2E-utilities.R")
#===============================================================================
...
genMCMC = function( data , zName="z" , NName="N" , sName="s" , cName="c" ,
  ...
  initsList = function() {
    ...
    for ( sIdx in 1:Nsubj ) { # for each subject
      ...
      # Adjust for players with zero attempts on 3 pointers, which causes resampledZ to be NA
      thetaInit[sIdx] = ifelse(is.na(resampledZ), 0.01, resampledZ/N[sIdx])
    }
